      ...
      <div className="grid items-center gap-12 md:grid-cols-2">
        <div className="step-in">
          ...
          <h1 className="mb-4 mt-5 text-balance font-[family-name:var(--font-display)] text-[38px] font-medium leading-[1.14] md:text-[50px]">
            Ein{" "}
            <em className="not-italic underline decoration-kirsche decoration-wavy decoration-[1.5px] underline-offset-8">
              Betriebssystem
            </em>{" "}
          ...
          <div className="mt-8 flex flex-wrap gap-3.5">
            <a href="#kontakt" className="w-btn hatch kirsche-hover border-[1.3px] border-ink bg-ink px-5 py-3 text-sm font-medium text-paper hover:-translate-x-px hover:-translate-y-px">
